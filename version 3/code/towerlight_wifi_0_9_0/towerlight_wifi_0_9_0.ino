...
#define       OLED_MODE_FOUR            4 // screen shows Custom text per - line
...
void updateSensor()
{
  ...
  {    
    ...
    {
      if (tempMode == MCP9808_C){temperature = tempSensor.readTempC();}
      if (tempMode == MCP9808_F){temperature = tempSensor.readTempF();}
      if (temperature != NAN)
      {
